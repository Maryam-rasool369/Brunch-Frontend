...
import styles from '../Css/latestBlogs.module.css'
  ...
  return (
    <>
        <div className={styles.top}>
            <Link to={'/blogs/allBlogs?type=latestBlogs'}  className={styles.topHeading}>Latest Blogs</Link>
            <Link to={'/blogs/allBlogs?type=latestBlogs'} className={styles.seeMore}>see more <FaArrowRight className={styles.arrow}/></Link>
        </div>
        <Swiper
        ...
        >
            {posts.filter((post)=>post.status === "approved").slice(0,6).map(post =>(
